...
<script>
    const app = {
        ...
        methods: {
            ...
            async GetGames(){
                let games = await fetch('<?php echo e(route('GetGames')); ?>');
                this.games = await games.json();
            },
            async AddGame(){
                let form = document.getElementById('add_form');
                let form_data = new FormData(form);
                const response = await fetch('<?php echo e(route('AddGameMain')); ?>',{
                    method: 'post',
                    headers:{
            ...
            async EditGame(id){
                ...
                const response = await fetch('<?php echo e(route('EditGameMain')); ?>',{
                    method: 'post',
                    headers:{
                        'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>',
                    },
            ...
            async show_page_game(id){
                const response = await fetch('<?php echo e(route('show_page_game')); ?>',{
                    method: 'post',
                    headers:{
                        'X-CSRF-TOKEN':'<?php echo e(csrf_token()); ?>',
                        'content-type':'application/json',
...
<?php echo $__env->make('admin.adminLayout.appAdmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Daniil\Desktop\sorter\resources\views/admin/index.blade.php ENDPATH**/ ?>