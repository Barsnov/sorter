    ...
    <div class="container" id="MainCreate">
        ...
        <div class="container" v-if="clicker == 1">
            <div class="d-flex flex-row gap-5">
                ...
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalCat">Добавить
                </button>

                <div class="modal fade" id="exampleModalCat" tabindex="-1" aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
                    ...
                    <tr v-for="cat in categories">
                        ...
                        <td>
                            <button class="btn btn-primary me-1" data-bs-toggle="modal"
                                    :data-bs-target="`#exampleModalCat_${cat.id}`">Редактировать
                            </button>

                            <div class="modal fade" :id="`exampleModalCat_${cat.id}`" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form @submit.prevent="EditGameCat(cat.category.id)"
                                              :id="`edit_form_${cat.category.id}`">
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="exampleInputTitle1" class="form-label">Назавние
                                                        категории</label>
                                                    <input name="title" type="text" :value="cat.category.title"
        ...
        <div class="container" v-if="clicker == 2">
            <div class="d-flex flex-row gap-5">
                ...
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalWord">Добавить
                </button>

                <div class="modal fade" id="exampleModalWord" tabindex="-1" aria-labelledby="exampleModalLabelWord"
                     aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="p-2" v-if="message != ''">
                            ...
                            <form @submit.prevent="AddGameWord" id="add_form_word">
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="select" class="form-label" style="color: black !important;">Выберите
                                            что вы хотите добавить:</label>
            ...
            <div>
                <table class="table mt-5">
                    ...
                    <tr v-for="word in words">
                        ...
                        <td>
                            <button class="btn btn-primary me-1" data-bs-toggle="modal"
                                    :data-bs-target="`#exampleModalWord_${word.id}`">Редактировать
                            </button>

                            <div class="modal fade" :id="`exampleModalWord_${word.id}`" tabindex="-1"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="p-2" v-if="message != ''">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="select" class="form-label"
                                                           style="color: black !important;">Выберите что вы хотите
                                                        добавить:</label>
                                                    <select class="form-select" v-model="SelectTypeFile">
                                                        <option selected disabled>Выберите наполнение игры</option>
                                                        <option value="0">Текст</option>
                                                ...
                                                <div class="mb-3" v-if="SelectTypeFile == 0">
                                                    <label for="exampleInputTitle1" class="form-label">Назавние
                                                        Слова</label>
                                                    <input name="title" type="text" :value="word.title"
                                                           class="form-control" id="exampleInputTitle1">
                                                </div>
                                                <div class="mb-3" v-if="SelectTypeFile == 1">
                                                    <label for="exampleInputImg1" class="form-label">Вставте
                                                        фото</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="select" class="form-label"
                                                           style="color: black !important;">Выберите категорию</label>
                                                    <select id="type_id" name="category" class="form-select">
                                                        <option v-for="category in categories"
                                                                :value="category.category.id"
                                                                :v-if="category.category.id == word.category_id">
                                                            @{{ category.category.title }}
                                                        </option>
                                                    </select>
                                                </div>
        ...
        <div class="container" v-if="clicker == 3">
            <div class="d-flex flex-row gap-5">
                ...
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalStyleAdd">Выбрать
                    стиль игре
                </button>

                <div class="modal fade" id="exampleModalStyleAdd" tabindex="-1" aria-labelledby="exampleModalLabelStyle"
                     aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="p-2" v-if="message != ''">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control mt-2 mb-2" name="style">
                                            <option v-for="style in stylesAll" :value="style.id">@{{ style.title }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
                ...
                <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModalStyle">Добавить
                    стиль
                </button>
                <div class="modal fade" id="exampleModalStyle" tabindex="-1" aria-labelledby="exampleModalStyle"
                     aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="p-2" v-if="message != ''">
            ...
            <div>
                ...
                <table class="table mt-5" v-if="styleStatus == 1">
                    ...
                    <tr v-for="style in styles">
                        ...
                        <td>
                            <button class="btn btn-primary me-1" data-bs-toggle="modal"
                                    :data-bs-target="`#exampleModalStyle_${style.style.id}`">Редактировать
                            </button>

                            <div class="modal fade" :id="`exampleModalStyle_${style.style.id}`" tabindex="-1"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="p-2" v-if="message != ''">
                                        ...
                                        <form @submit.prevent="EditGameStyle(style.style.id)"
                                              :id="`edit_form_style_${style.style.id}`">
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="exampleInputTitle1" class="form-label">Назавние
                                                        Стиля</label>
                                                    <input name="title" type="text" :value="style.style.title"
                                                           class="form-control" id="exampleInputTitle1">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleInputImg1" class="form-label">Вставте
                ...
                <table class="table mt-5" v-if="styleStatus == 0">
                    ...
                    <tr v-for="style in stylesAll">
                        ...
                        <td>
                            <button class="btn btn-primary me-1" data-bs-toggle="modal"
                                    :data-bs-target="`#exampleModalStyle_${style.id}`">Редактировать
                            </button>

                            <div class="modal fade" :id="`exampleModalStyle_${style.id}`" tabindex="-1"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="p-2" v-if="message != ''">
                                        ...
                                        <form @submit.prevent="EditGameStyle(style.id)"
                                              :id="`edit_form_style_${style.id}`">
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="exampleInputTitle1" class="form-label">Назавние
                                                        Стиля</label>
                                                    <input name="title" type="text" :value="style.title"
                                                           class="form-control" id="exampleInputTitle1">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="exampleInputImg1" class="form-label">Вставте
        ...
        const app = {
            ...
            methods: {
                ...
                async GetCategoriesGame() {
                    let id = `{{ $game->id }}`;
                    const response = await fetch('{{route('GetCategoriesGame')}}', {
                        method: 'post',
                        headers: {
                ...
                async AddGameCat() {
                    ...
                    const response = await fetch('{{route('AddGameCategory')}}', {
                        method: 'post',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        },
                ...
                async GetWordsGame() {
                    let id = `{{ $game->id }}`;
                    const response = await fetch('{{route('GetWordsGame')}}', {
                        method: 'post',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                            'content-type': 'application/json',
                ...
                async AddGameWord() {
                    ...
                    let form_data = new FormData(form);
                    form_data.append('id', id);
                    const response = await fetch('{{route('AddGameWord')}}', {
                        method: 'post',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        },
                ...
                async ChoseStyleGame() {
                    ...
                    let form_data = new FormData(form);
                    form_data.append('id', id);
                    const response = await fetch('{{route('ChoseGameStyle')}}', {
                        method: 'post',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        },
                ...
                async GetStylesGame() {
                    let id = `{{ $game->id }}`;
                    const response = await fetch('{{route('GetStylesGame')}}', {
                        method: 'post',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                            'content-type': 'application/json',
                ...
                async AddGameStyle() {
                    ...
                    let form_data = new FormData(form);
                    form_data.append('id', id);
                    const response = await fetch('{{route('AddGameStyle')}}', {
                        method: 'post',
                        headers: {
                            'X-CSRF-TOKEN': '{{ csrf_token() }}',
                        },
